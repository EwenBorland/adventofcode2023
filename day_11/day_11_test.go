...
var test_answer_part_1 int64 = 374
...
func Test_day_11(t *testing.T) {
	...
	output_part1, output_part2 := day_11.Day_11(scanner)
	if output_part1 != test_answer_part_1 {
		t.Errorf("day_11 part 1 fault, want: %v, got: %v", test_answer_part_1, output_part1)
	}
	if output_part2 != test_answer_part_2 {
		t.Errorf("day_11 part 2 fault, want: %v, got: %v", test_answer_part_2, output_part2)
	}
}
